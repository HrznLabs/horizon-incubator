...
## YYYY-MM-DD - Accessible Decorative Pseudo-elements
**Learning:** When using CSS pseudo-elements (`::before`, `::after`) for decorative characters, screen readers may read them aloud.
**Action:** Use CSS alternative text syntax (`content: "→" / "";`) with a standard fallback to hide them accessibly.
