...
## 2026-07-18 - Prevent Redundant Screen Reader Announcements in Tooltips
...
**Action:** Add `content: attr(aria-label) / "";` immediately after the standard fallback to accessibly hide the pseudo-element's content from screen readers while preserving the visual tooltip.
